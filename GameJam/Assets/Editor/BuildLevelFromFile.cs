...
public class BuildLevelFromFile : MonoBehaviour
{
    ...
    static PrefabInfo[] all = new PrefabInfo[] {
        ...
        new PrefabInfo('1', "Assets/Prefabs/Players/2DPlayer1.prefab"),
        new PrefabInfo('2', "Assets/Prefabs/Players/2DPlayer2.prefab"),
        new PrefabInfo('3', "Assets/Prefabs/Players/2DPlayerSolo.prefab"),
        ...
        new PrefabInfo('h', "Assets/Prefabs/Muros/MuroCorazon.prefab")
